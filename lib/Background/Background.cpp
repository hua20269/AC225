...
void DisplayInit() // 屏幕初始化
{
    ...
    // else
    lcd.setBrightness(200); // 设置屏幕显示亮度
    // 初始化画布及清屏
            ...
            uint8_t bat_per, uint8_t sys_state, uint8_t ac_state, uint8_t sinkProtocol, uint8_t sourceProtocol, uint8_t smalla, uint8_t ble_state, uint8_t cycle)
{
    ...
    else if (sys_state == 1) // 放电
    {
        ...
        case 5:
            ...
            break;
        case 6:
            sprite1.drawString("PE2.0", 203, 89);
            break;
        case 7:
            ...
            uint8_t bat_per, uint8_t sys_state, uint8_t ac_state, uint8_t sinkProtocol, uint8_t sourceProtocol, uint8_t smalla, uint8_t ble_state, uint8_t cycle)
{
    ...
    sprintf(draw_num, "%d", bat_per); // 百分比
                                      // if (bat_per == 100)
                                      //     sprite1.drawString(draw_num, 70, 80);
                                      // else
                                      // {
    if (bat_per <= 20)
    ...
    sprite1.drawString("%", 110, 120);
    // 画圈
    sprite1.drawCircle(70, 90, 68, TFT_BLUE);
    /**
            ...
            uint8_t bat_per, uint8_t sys_state, uint8_t ac_state, uint8_t sinkProtocol, uint8_t sourceProtocol, uint8_t smalla, uint8_t ble_state, uint8_t cycle)
{
    ...
    else if (sys_state == 1) // 放电
    {
        ...
        case 5:
            ...
            break;
        case 6:
            sprite1.drawString("PE2.0", 120, 0);
            break;
        case 7:
...
void WiFi_Page()
{
    ...
    sprite1.drawString("PASS: 12345678", 120, 80);
